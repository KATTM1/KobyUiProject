...
local KOBY117SC = Instance.new("ScreenGui")
KOBY117SC.Name = _G.Key .."," .. _G.Discord
KOBY117SC.Parent = game.CoreGui
KOBY117SC.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

game:GetService("UserInputService").InputBegan:connect(function(inputObject, gameProcessedEvent)
   if inputObject.KeyCode == Enum.KeyCode.RightControl then
      wait()
      KOBY117SC.Enabled = not KOBY117SC.Enabled
   end
end)

function KOBY117:Window(text,maincolor)
   ...
   UserTag.TextColor3 = Color3.fromRGB(0, 128, 255)
   ...
   function KOBY117:Notification(titletext, desctext, btntext)
   ...
   function ServerHold:Server(text,textgame, img)
      ...
      Server.TextColor3 = Color3.fromRGB(0, 128, 255)
      ...
      ServerTitle.TextColor3 = Color3.fromRGB(0, 128, 255)
      ...
      function ChannelHold:Channel(text)
         ...
         function ChannelContent:Toggle(text,default,callback)
            ...
            Toggle.MouseButton1Click:Connect(function()
               if toggled == false then
                  ...
                  TweenService:Create(ToggleFrame,TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{BackgroundColor3 = Color3.fromRGB(0, 128, 255)}):Play()
         ...
         function ChannelContent:Slider(text, min, max, start, callback)
            ...
            SliderTitle.BackgroundColor3 = Color3.fromRGB(0, 128, 255)
            ...
            CurrentValueFrame.BackgroundColor3 = Color3.fromRGB(0, 128, 255)
         ...
         function ChannelContent:Dropdown(text, list, callback)
            ...
            DropItemHolder.ScrollBarImageColor3 = Color3.fromRGB(0, 128, 255)
